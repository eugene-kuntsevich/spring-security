...
public class MyOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User>
{
	...
	private static final ParameterizedTypeReference<java.util.Map<String, Object>> PARAMETERIZED_RESPONSE_TYPE = new ParameterizedTypeReference<java.util.Map<String, Object>>()
	{
	};
	...
	public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException
	{
		...
		java.util.Map<String, Object> userAttributes = emptyIfNull(response.getBody());

		java.util.Set<GrantedAuthority> authorities = new LinkedHashSet<>();
